...
public class ModelRay<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("mocreatures", "model_ray"), "main");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Tail = partdefinition.addOrReplaceChild(
         "Tail",
         CubeListBuilder.create().texOffs(30, 15).addBox(-0.525F, -0.5F, 0.75F, 1.0F, 1.0F, 16.0F, new CubeDeformation(0.0F)),
      ...
      PartDefinition RWingC = RWingB.addOrReplaceChild(
         "RWingC",
         CubeListBuilder.create().texOffs(5, 4).addBox(-2.0F, -0.5F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)),
         PartPose.offset(-3.0F, 0.0F, 0.0F)
      );
      PartDefinition RWingD = RWingC.addOrReplaceChild(
         "RWingD",
         CubeListBuilder.create().texOffs(6, 5).addBox(-2.0F, -0.5F, -2.5F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
         PartPose.offset(-2.0F, 0.0F, 0.0F)
      );
      PartDefinition RWingE = RWingD.addOrReplaceChild(
         "RWingE",
         CubeListBuilder.create().texOffs(7, 6).addBox(-2.0F, -0.5F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
         PartPose.offset(-2.0F, 0.0F, 0.0F)
      );
      PartDefinition RWingF = RWingE.addOrReplaceChild(
         "RWingF",
         CubeListBuilder.create().texOffs(8, 7).addBox(-2.0F, -0.5F, -1.5F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
         PartPose.offset(-2.0F, 0.0F, 0.0F)
      );
      PartDefinition RWingG = RWingF.addOrReplaceChild(
         "RWingG",
         CubeListBuilder.create().texOffs(9, 8).addBox(-2.0F, -0.5F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
         PartPose.offset(-2.0F, 0.0F, 0.0F)
      );
      PartDefinition BodyTail = partdefinition.addOrReplaceChild(
         "BodyTail",
         CubeListBuilder.create().texOffs(0, 20).addBox(-2.05F, -0.5F, -3.2F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
         PartPose.offset(-0.5F, 22.0F, 7.0F)
      );
      ...
      PartDefinition LWingC = LWingB.addOrReplaceChild(
         "LWingC",
         CubeListBuilder.create().texOffs(5, 4).mirror().addBox(0.0F, -0.5F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false),
         PartPose.offset(3.0F, 0.0F, 0.0F)
      );
      PartDefinition LWingD = LWingC.addOrReplaceChild(
         "LWingD",
         CubeListBuilder.create().texOffs(6, 5).mirror().addBox(0.0F, -0.5F, -2.5F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
         PartPose.offset(2.0F, 0.0F, 0.0F)
      );
      PartDefinition LWingE = LWingD.addOrReplaceChild(
         "LWingE",
         CubeListBuilder.create().texOffs(7, 6).mirror().addBox(0.0F, -0.5F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
         PartPose.offset(2.0F, 0.0F, 0.0F)
      );
      PartDefinition LWingF = LWingE.addOrReplaceChild(
         "LWingF",
         CubeListBuilder.create().texOffs(8, 7).mirror().addBox(0.0F, -0.5F, -1.5F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
         PartPose.offset(2.0F, 0.0F, 0.0F)
      );
      PartDefinition LWingG = LWingF.addOrReplaceChild(
         "LWingG",
         CubeListBuilder.create().texOffs(9, 8).mirror().addBox(0.0F, -0.5F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
         PartPose.offset(2.0F, 0.0F, 0.0F)
      );
