...
import net.mocreatures.entity.model.BoarModel;
...
public class BoarRenderer extends GeoEntityRenderer<BoarEntity> {
   ...
   public RenderType getRenderType(BoarEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
