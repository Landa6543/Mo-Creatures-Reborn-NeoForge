...
public abstract class FurArmorItem extends ArmorItem {
      ...
      event.register(
         ...
         registerHelper -> {
            ArmorMaterial armorMaterial = new ArmorMaterial(
               ...
               () -> Ingredient.of(new ItemStack[]{new ItemStack((ItemLike)MocreaturesModItems.FUR.get())}),
               List.of(new Layer(ResourceLocation.parse("mocreatures:fur_1"))),
               0.0F,
               0.0F
            );
            registerHelper.register(ResourceLocation.parse("mocreatures:fur_armor"), armorMaterial);
            ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
         }
      );
   }

   public FurArmorItem(Type type, Properties properties) {
      super(ARMOR_MATERIAL, type, properties);
   }

   public static class Boots extends FurArmorItem {
      public Boots() {
         super(Type.BOOTS, new Properties().durability(Type.BOOTS.getDurability(15)));
      }
   }

   public static class Chestplate extends FurArmorItem {
      public Chestplate() {
         super(Type.CHESTPLATE, new Properties().durability(Type.CHESTPLATE.getDurability(15)));
      }
   }

   public static class Helmet extends FurArmorItem {
      public Helmet() {
         super(Type.HELMET, new Properties().durability(Type.HELMET.getDurability(15)));
      }
   }

   public static class Leggings extends FurArmorItem {
      public Leggings() {
