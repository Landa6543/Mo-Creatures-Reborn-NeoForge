...
public class UndeadScorpionBladeItem extends SwordItem {
   ...
   public UndeadScorpionBladeItem() {
   ...
   public void appendHoverText(ItemStack itemstack, TooltipContext context, List<Component> list, TooltipFlag flag) {
      ...
      list.add(Component.translatable("item.mocreatures.undead_scorpion_blade.description_0"));
   }
}
