...
public class CaveScorpionMattockItem extends PickaxeItem {
   ...
   public CaveScorpionMattockItem() {
   ...
   public void appendHoverText(ItemStack itemstack, TooltipContext context, List<Component> list, TooltipFlag flag) {
      ...
      list.add(Component.translatable("item.mocreatures.cave_scorpion_mattock.description_0"));
   }
}
