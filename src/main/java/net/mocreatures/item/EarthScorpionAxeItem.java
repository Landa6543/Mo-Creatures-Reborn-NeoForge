...
public class EarthScorpionAxeItem extends AxeItem {
   ...
   public void appendHoverText(ItemStack itemstack, TooltipContext context, List<Component> list, TooltipFlag flag) {
      ...
      list.add(Component.translatable("item.mocreatures.earth_scorpion_axe.description_0"));
   }
}
