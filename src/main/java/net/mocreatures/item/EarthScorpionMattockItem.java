...
public class EarthScorpionMattockItem extends PickaxeItem {
   ...
   public EarthScorpionMattockItem() {
   ...
   public void appendHoverText(ItemStack itemstack, TooltipContext context, List<Component> list, TooltipFlag flag) {
      ...
      list.add(Component.translatable("item.mocreatures.earth_scorpion_mattock.description_0"));
   }
}
