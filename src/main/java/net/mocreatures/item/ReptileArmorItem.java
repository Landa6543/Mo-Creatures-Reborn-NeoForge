      ...
      event.register(
         ...
         registerHelper -> {
            ArmorMaterial armorMaterial = new ArmorMaterial(
               ...
               () -> Ingredient.of(),
               List.of(new Layer(ResourceLocation.parse("mocreatures:croc_1"))),
               0.0F,
               0.0F
            );
            registerHelper.register(ResourceLocation.parse("mocreatures:reptile_armor"), armorMaterial);
            ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
         }
      );
   }

   public ReptileArmorItem(Type type, Properties properties) {
