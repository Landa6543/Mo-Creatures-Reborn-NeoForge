...
public class UndeadScorpionAxeItem extends AxeItem {
   ...
   public void appendHoverText(ItemStack itemstack, TooltipContext context, List<Component> list, TooltipFlag flag) {
      ...
      list.add(Component.translatable("item.mocreatures.undead_scorpion_axe.description_0"));
   }
}
