...
public class CaveScorpionBladeItem extends SwordItem {
   ...
   public void appendHoverText(ItemStack itemstack, TooltipContext context, List<Component> list, TooltipFlag flag) {
      ...
      list.add(Component.translatable("item.mocreatures.cave_scorpion_blade.description_0"));
   }
}
