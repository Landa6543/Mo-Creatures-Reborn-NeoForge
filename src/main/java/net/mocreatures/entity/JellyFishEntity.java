...
import net.mocreatures.procedures.JellyFishSpawnProcedure;
...
public class JellyFishEntity extends TamableAnimal implements GeoEntity {
      ...
      this.moveControl = new MoveControl(this) {
         public void tick() {
            if (JellyFishEntity.this.isInWater()) {
               JellyFishEntity.this.setDeltaMovement(JellyFishEntity.this.getDeltaMovement().add(0.0, 0.005, 0.0));
            }

            if (this.operation == Operation.MOVE_TO && !JellyFishEntity.this.getNavigation().isDone()) {
               ...
               JellyFishEntity.this.setYRot(this.rotlerp(JellyFishEntity.this.getYRot(), f, 10.0F));
               ...
               if (JellyFishEntity.this.isInWater()) {
                  ...
                  JellyFishEntity.this.setXRot(this.rotlerp(JellyFishEntity.this.getXRot(), f2, 5.0F));
               ...
               JellyFishEntity.this.setSpeed(0.0F);
               JellyFishEntity.this.setYya(0.0F);
               JellyFishEntity.this.setZza(0.0F);
            }
         }
      };
   }
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "jellyfish_purple");
   }
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata) {
      ...
      JellyFishSpawnProcedure.execute(this);
      return retval;
   }
   ...
   public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
      JellyFishEntity retval = (JellyFishEntity)(MocreaturesModEntities.JELLYFISH.get()).create(serverWorld);
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         MocreaturesModEntities.JELLYFISH.get(),
