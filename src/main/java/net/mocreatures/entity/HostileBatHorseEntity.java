...
public class HostileBatHorseEntity extends Monster {
   public HostileBatHorseEntity(EntityType<HostileBatHorseEntity> type, Level world) {
      super(type, world);
      this.xpReward = 0;
      this.setNoAi(false);
   }
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         MocreaturesModEntities.HOSTILE_BAT_HORSE.get(),
