...
import net.mocreatures.procedures.PolarBearOnEntityTickUpdateProcedure;
import net.mocreatures.procedures.PolarBearRightClickedOnEntityProcedure;
import net.mocreatures.procedures.PolarBearSpawnProcedure;
...
public class PolarBearEntity extends TamableAnimal implements GeoEntity {
   ...
   public static final EntityDataAccessor<Boolean> DATA_Saddled = SynchedEntityData.defineId(PolarBearEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Boolean> DATA_Sit = SynchedEntityData.defineId(PolarBearEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Boolean> DATA_Baby = SynchedEntityData.defineId(PolarBearEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Integer> DATA_GrowUp = SynchedEntityData.defineId(PolarBearEntity.class, EntityDataSerializers.INT);
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "bear_polar_bare");
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata) {
      ...
      PolarBearSpawnProcedure.execute(this);
      return retval;
   }
   ...
   public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
      ...
      PolarBearRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
      return retval;
   }

   public void baseTick() {
      super.baseTick();
      PolarBearOnEntityTickUpdateProcedure.execute(this);
   ...
   public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
      PolarBearEntity retval = (PolarBearEntity)(MocreaturesModEntities.POLAR_BEAR.get()).create(serverWorld);
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         MocreaturesModEntities.POLAR_BEAR.get(),
