...
import net.mocreatures.procedures.PiranhaBabyProcedure;
import net.mocreatures.procedures.PiranhaBabyRightClickedProcedure;
...
public class PiranhaEntity extends TamableAnimal implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(PiranhaEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(PiranhaEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(PiranhaEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<Boolean> DATA_Baby = SynchedEntityData.defineId(PiranhaEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Integer> DATA_GrowUp = SynchedEntityData.defineId(PiranhaEntity.class, EntityDataSerializers.INT);
      ...
      this.moveControl = new MoveControl(this) {
         public void tick() {
            if (PiranhaEntity.this.isInWater()) {
               PiranhaEntity.this.setDeltaMovement(PiranhaEntity.this.getDeltaMovement().add(0.0, 0.005, 0.0));
            }

            if (this.operation == Operation.MOVE_TO && !PiranhaEntity.this.getNavigation().isDone()) {
               ...
               PiranhaEntity.this.setYRot(this.rotlerp(PiranhaEntity.this.getYRot(), f, 10.0F));
               ...
               if (PiranhaEntity.this.isInWater()) {
                  ...
                  PiranhaEntity.this.setXRot(this.rotlerp(PiranhaEntity.this.getXRot(), f2, 5.0F));
               ...
               PiranhaEntity.this.setSpeed(0.0F);
               PiranhaEntity.this.setYya(0.0F);
               PiranhaEntity.this.setZza(0.0F);
            }
         }
      };
   }
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "smallfish_piranha");
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(2, new RandomSwimmingGoal(this, 16.0, 40));
   ...
   public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
      ...
      PiranhaBabyRightClickedProcedure.execute(world, x, y, z, entity, sourceentity);
      return retval;
   }

   public void baseTick() {
      super.baseTick();
      PiranhaBabyProcedure.execute(this.level(), this);
   ...
   public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
      PiranhaEntity retval = (PiranhaEntity)(MocreaturesModEntities.PIRANHA.get()).create(serverWorld);
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         MocreaturesModEntities.PIRANHA.get(),
