...
public class DeerStagEntity extends Animal {
   public static final EntityDataAccessor<Boolean> DATA_Breed = SynchedEntityData.defineId(DeerStagEntity.class, EntityDataSerializers.BOOLEAN);
   public final AnimationState animationState1 = new AnimationState();

   public DeerStagEntity(EntityType<DeerStagEntity> type, Level world) {
      super(type, world);
      this.xpReward = 3;
      this.setNoAi(false);
   ...
   public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
      DeerStagEntity retval = (DeerStagEntity)(MocreaturesModEntities.DEER_STAG.get()).create(serverWorld);
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         MocreaturesModEntities.DEER_STAG.get(),
