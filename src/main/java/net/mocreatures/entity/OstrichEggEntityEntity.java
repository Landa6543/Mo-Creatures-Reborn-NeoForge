...
import net.mocreatures.procedures.OstrichEggHatchProcedure;
...
public class OstrichEggEntityEntity extends PathfinderMob implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(OstrichEggEntityEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(OstrichEggEntityEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(OstrichEggEntityEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<Integer> DATA_Hatch = SynchedEntityData.defineId(OstrichEggEntityEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Boolean> DATA_Crack1 = SynchedEntityData.defineId(OstrichEggEntityEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Boolean> DATA_Crack2 = SynchedEntityData.defineId(OstrichEggEntityEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Boolean> DATA_Crack3 = SynchedEntityData.defineId(OstrichEggEntityEntity.class, EntityDataSerializers.BOOLEAN);
   ...
   public OstrichEggEntityEntity(EntityType<OstrichEggEntityEntity> type, Level world) {
      super(type, world);
      this.xpReward = 0;
      this.setNoAi(false);
   ...
   public void baseTick() {
      super.baseTick();
      OstrichEggHatchProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
