...
import net.mocreatures.procedures.MandarinfishEggHatchProcedure;
...
public class MandarinfishEggEntityEntity extends PathfinderMob implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(MandarinfishEggEntityEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(MandarinfishEggEntityEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(MandarinfishEggEntityEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<Integer> DATA_Hatch = SynchedEntityData.defineId(MandarinfishEggEntityEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Boolean> DATA_Crack1 = SynchedEntityData.defineId(MandarinfishEggEntityEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Boolean> DATA_Crack2 = SynchedEntityData.defineId(MandarinfishEggEntityEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Boolean> DATA_Crack3 = SynchedEntityData.defineId(MandarinfishEggEntityEntity.class, EntityDataSerializers.BOOLEAN);
   ...
   public MandarinfishEggEntityEntity(EntityType<MandarinfishEggEntityEntity> type, Level world) {
      super(type, world);
      this.xpReward = 0;
      this.setNoAi(false);
   ...
   public void baseTick() {
      super.baseTick();
      MandarinfishEggHatchProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
