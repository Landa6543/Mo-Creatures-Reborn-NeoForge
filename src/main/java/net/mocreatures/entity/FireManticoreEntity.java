...
import net.mocreatures.procedures.FireManticoreBabyProcedure;
import net.mocreatures.procedures.FireManticoreBabyRightClickedProcedure;
import net.mocreatures.procedures.FireManticoreDiesProcedure;
import net.mocreatures.procedures.FireManticorePassiveBabyProcedure;
...
public class FireManticoreEntity extends TamableAnimal implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(FireManticoreEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(FireManticoreEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(FireManticoreEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<Boolean> DATA_Saddled = SynchedEntityData.defineId(FireManticoreEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Boolean> DATA_Baby = SynchedEntityData.defineId(FireManticoreEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Integer> DATA_GrowUp = SynchedEntityData.defineId(FireManticoreEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Boolean> DATA_Fly = SynchedEntityData.defineId(FireManticoreEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Boolean> DATA_Grounded = SynchedEntityData.defineId(FireManticoreEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Integer> DATA_FlyCooldown = SynchedEntityData.defineId(FireManticoreEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> DATA_GroundedCooldown = SynchedEntityData.defineId(FireManticoreEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> DATA_StingCount = SynchedEntityData.defineId(FireManticoreEntity.class, EntityDataSerializers.INT);
   ...
   public FireManticoreEntity(EntityType<FireManticoreEntity> type, Level world) {
      super(type, world);
      this.xpReward = 5;
      this.setNoAi(false);
   }
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "manticore_fire_bare");
         ...
         .addGoal(
            ...
            new MeleeAttackGoal(this, 1.2, false) {
               ...
               public boolean canUse() {
                  double x = FireManticoreEntity.this.getX();
                  double y = FireManticoreEntity.this.getY();
                  double z = FireManticoreEntity.this.getZ();
                  Entity entity = FireManticoreEntity.this;
                  Level world = FireManticoreEntity.this.level();
                  return super.canUse() && FireManticorePassiveBabyProcedure.execute(entity);
               }
            }
         );
   ...
   public void die(DamageSource source) {
      super.die(source);
      FireManticoreDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   }
   ...
   public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
      ...
      FireManticoreBabyRightClickedProcedure.execute(world, x, y, z, entity, sourceentity);
      return retval;
   }

   public void baseTick() {
      super.baseTick();
      FireManticoreBabyProcedure.execute(this);
   ...
   public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
      FireManticoreEntity retval = (FireManticoreEntity)(MocreaturesModEntities.FIRE_MANTICORE.get()).create(serverWorld);
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         MocreaturesModEntities.FIRE_MANTICORE.get(),
