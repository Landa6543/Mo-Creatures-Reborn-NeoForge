...
import net.mocreatures.procedures.DarkManticoreBabyProcedure;
import net.mocreatures.procedures.DarkManticoreBabyRightClickedProcedure;
import net.mocreatures.procedures.DarkManticoreDiesProcedure;
import net.mocreatures.procedures.DarkManticorePassiveBabyProcedure;
...
public class DarkManticoreEntity extends TamableAnimal implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(DarkManticoreEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(DarkManticoreEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(DarkManticoreEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<Boolean> DATA_Saddled = SynchedEntityData.defineId(DarkManticoreEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Boolean> DATA_Baby = SynchedEntityData.defineId(DarkManticoreEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Integer> DATA_GrowUp = SynchedEntityData.defineId(DarkManticoreEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Boolean> DATA_Fly = SynchedEntityData.defineId(DarkManticoreEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Boolean> DATA_Grounded = SynchedEntityData.defineId(DarkManticoreEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Integer> DATA_FlyCooldown = SynchedEntityData.defineId(DarkManticoreEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> DATA_GroundedCooldown = SynchedEntityData.defineId(DarkManticoreEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> DATA_StingCount = SynchedEntityData.defineId(DarkManticoreEntity.class, EntityDataSerializers.INT);
   ...
   public DarkManticoreEntity(EntityType<DarkManticoreEntity> type, Level world) {
      super(type, world);
      this.xpReward = 5;
      this.setNoAi(false);
   }
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "manticore_dark_bare");
         ...
         .addGoal(
            ...
            new MeleeAttackGoal(this, 1.2, false) {
               ...
               public boolean canUse() {
                  double x = DarkManticoreEntity.this.getX();
                  double y = DarkManticoreEntity.this.getY();
                  double z = DarkManticoreEntity.this.getZ();
                  Entity entity = DarkManticoreEntity.this;
                  Level world = DarkManticoreEntity.this.level();
                  return super.canUse() && DarkManticorePassiveBabyProcedure.execute(entity);
               }
            }
         );
   ...
   public void die(DamageSource source) {
      super.die(source);
      DarkManticoreDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   }
   ...
   public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
      ...
      DarkManticoreBabyRightClickedProcedure.execute(world, x, y, z, entity, sourceentity);
      return retval;
   }

   public void baseTick() {
      super.baseTick();
      DarkManticoreBabyProcedure.execute(this);
   ...
   public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
      DarkManticoreEntity retval = (DarkManticoreEntity)(MocreaturesModEntities.DARK_MANTICORE.get()).create(serverWorld);
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         MocreaturesModEntities.DARK_MANTICORE.get(),
