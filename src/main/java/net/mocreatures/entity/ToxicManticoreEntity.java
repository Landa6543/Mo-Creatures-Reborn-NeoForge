...
import net.mocreatures.procedures.ToxicManticoreBabyProcedure;
import net.mocreatures.procedures.ToxicManticoreBabyRightClickedProcedure;
import net.mocreatures.procedures.ToxicManticoreDiesProcedure;
import net.mocreatures.procedures.ToxicManticorePassiveBabyProcedure;
...
public class ToxicManticoreEntity extends TamableAnimal implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ToxicManticoreEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ToxicManticoreEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ToxicManticoreEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<Boolean> DATA_Saddled = SynchedEntityData.defineId(ToxicManticoreEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Boolean> DATA_Baby = SynchedEntityData.defineId(ToxicManticoreEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Integer> DATA_GrowUp = SynchedEntityData.defineId(ToxicManticoreEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Boolean> DATA_Fly = SynchedEntityData.defineId(ToxicManticoreEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Boolean> DATA_Grounded = SynchedEntityData.defineId(ToxicManticoreEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Integer> DATA_FlyCooldown = SynchedEntityData.defineId(ToxicManticoreEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> DATA_GroundedCooldown = SynchedEntityData.defineId(ToxicManticoreEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> DATA_StingCount = SynchedEntityData.defineId(ToxicManticoreEntity.class, EntityDataSerializers.INT);
   ...
   public ToxicManticoreEntity(EntityType<ToxicManticoreEntity> type, Level world) {
      super(type, world);
      this.xpReward = 5;
      this.setNoAi(false);
   }
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "manticore_toxic_bare");
         ...
         .addGoal(
            ...
            new MeleeAttackGoal(this, 1.2, false) {
               ...
               public boolean canUse() {
                  double x = ToxicManticoreEntity.this.getX();
                  double y = ToxicManticoreEntity.this.getY();
                  double z = ToxicManticoreEntity.this.getZ();
                  Entity entity = ToxicManticoreEntity.this;
                  Level world = ToxicManticoreEntity.this.level();
                  return super.canUse() && ToxicManticorePassiveBabyProcedure.execute(entity);
               }
            }
         );
   ...
   public void die(DamageSource source) {
      super.die(source);
      ToxicManticoreDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   }
   ...
   public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
      ...
      ToxicManticoreBabyRightClickedProcedure.execute(world, x, y, z, entity, sourceentity);
      return retval;
   }

   public void baseTick() {
      super.baseTick();
      ToxicManticoreBabyProcedure.execute(this);
   ...
   public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
      ToxicManticoreEntity retval = (ToxicManticoreEntity)(MocreaturesModEntities.TOXIC_MANTICORE.get()).create(serverWorld);
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         MocreaturesModEntities.TOXIC_MANTICORE.get(),
