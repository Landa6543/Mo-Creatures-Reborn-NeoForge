...
public class FireManticoreModel extends GeoModel<FireManticoreEntity> {
   public ResourceLocation getAnimationResource(FireManticoreEntity var1) {
      return ResourceLocation.parse("mocreatures:animations/manticore.animation.json");
   }

   public ResourceLocation getModelResource(FireManticoreEntity var1) {
      return ResourceLocation.parse("mocreatures:geo/manticore.geo.json");
   }

   public ResourceLocation getTextureResource(FireManticoreEntity var1) {
      return ResourceLocation.parse("mocreatures:textures/entities/" + var1.getTexture() + ".png");
   }

   public void setCustomAnimations(FireManticoreEntity var1, long var2, AnimationState var4) {
