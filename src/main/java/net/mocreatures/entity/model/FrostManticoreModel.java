...
public class FrostManticoreModel extends GeoModel<FrostManticoreEntity> {
   public ResourceLocation getAnimationResource(FrostManticoreEntity var1) {
      return ResourceLocation.parse("mocreatures:animations/manticore.animation.json");
   }

   public ResourceLocation getModelResource(FrostManticoreEntity var1) {
      return ResourceLocation.parse("mocreatures:geo/manticore.geo.json");
   }

   public ResourceLocation getTextureResource(FrostManticoreEntity var1) {
      return ResourceLocation.parse("mocreatures:textures/entities/" + var1.getTexture() + ".png");
   }

   public void setCustomAnimations(FrostManticoreEntity var1, long var2, AnimationState var4) {
