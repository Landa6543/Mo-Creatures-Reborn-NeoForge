...
public class ToxicManticoreModel extends GeoModel<ToxicManticoreEntity> {
   public ResourceLocation getAnimationResource(ToxicManticoreEntity var1) {
      return ResourceLocation.parse("mocreatures:animations/manticore.animation.json");
   }

   public ResourceLocation getModelResource(ToxicManticoreEntity var1) {
      return ResourceLocation.parse("mocreatures:geo/manticore.geo.json");
   }

   public ResourceLocation getTextureResource(ToxicManticoreEntity var1) {
      return ResourceLocation.parse("mocreatures:textures/entities/" + var1.getTexture() + ".png");
   }

   public void setCustomAnimations(ToxicManticoreEntity var1, long var2, AnimationState var4) {
