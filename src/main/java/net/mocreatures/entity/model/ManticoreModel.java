...
public class ManticoreModel extends GeoModel<ManticoreEntity> {
   public ResourceLocation getAnimationResource(ManticoreEntity var1) {
      return ResourceLocation.parse("mocreatures:animations/manticore.animation.json");
   }

   public ResourceLocation getModelResource(ManticoreEntity var1) {
      return ResourceLocation.parse("mocreatures:geo/manticore.geo.json");
   }

   public ResourceLocation getTextureResource(ManticoreEntity var1) {
      return ResourceLocation.parse("mocreatures:textures/entities/" + var1.getTexture() + ".png");
   }

   public void setCustomAnimations(ManticoreEntity var1, long var2, AnimationState var4) {
