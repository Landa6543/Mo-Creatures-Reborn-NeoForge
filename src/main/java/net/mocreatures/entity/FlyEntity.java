...
public class FlyEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new RandomStrollGoal(this, 1.0, 20) {
         protected Vec3 getPosition() {
            ...
            double dir_x = FlyEntity.this.getX() + (random.nextFloat() * 2.0F - 1.0F) * 16.0F;
            double dir_y = FlyEntity.this.getY() + (random.nextFloat() * 2.0F - 1.0F) * 16.0F;
            double dir_z = FlyEntity.this.getZ() + (random.nextFloat() * 2.0F - 1.0F) * 16.0F;
   ...
   public SoundEvent getAmbientSound() {
      return (SoundEvent)BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("mocreatures:fly_ambient"));
   }

   public SoundEvent getHurtSound(DamageSource ds) {
      return (SoundEvent)BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("mocreatures:fly_hurt"));
   }
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         MocreaturesModEntities.FLY.get(),
