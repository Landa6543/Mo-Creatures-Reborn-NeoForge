...
import net.mocreatures.procedures.FrostManticoreBabyProcedure;
import net.mocreatures.procedures.FrostManticoreBabyRightClickedProcedure;
import net.mocreatures.procedures.FrostManticoreDiesProcedure;
import net.mocreatures.procedures.FrostManticorePassiveBabyProcedure;
...
public class FrostManticoreEntity extends TamableAnimal implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(FrostManticoreEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(FrostManticoreEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(FrostManticoreEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<Boolean> DATA_Saddled = SynchedEntityData.defineId(FrostManticoreEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Boolean> DATA_Baby = SynchedEntityData.defineId(FrostManticoreEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Integer> DATA_GrowUp = SynchedEntityData.defineId(FrostManticoreEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Boolean> DATA_Fly = SynchedEntityData.defineId(FrostManticoreEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Boolean> DATA_Grounded = SynchedEntityData.defineId(FrostManticoreEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Integer> DATA_FlyCooldown = SynchedEntityData.defineId(FrostManticoreEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> DATA_GroundedCooldown = SynchedEntityData.defineId(FrostManticoreEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> DATA_StingCount = SynchedEntityData.defineId(FrostManticoreEntity.class, EntityDataSerializers.INT);
   ...
   public FrostManticoreEntity(EntityType<FrostManticoreEntity> type, Level world) {
      super(type, world);
      this.xpReward = 5;
      this.setNoAi(false);
   }
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "manticore_frost_bare");
         ...
         .addGoal(
            ...
            new MeleeAttackGoal(this, 1.2, false) {
               ...
               public boolean canUse() {
                  double x = FrostManticoreEntity.this.getX();
                  double y = FrostManticoreEntity.this.getY();
                  double z = FrostManticoreEntity.this.getZ();
                  Entity entity = FrostManticoreEntity.this;
                  Level world = FrostManticoreEntity.this.level();
                  return super.canUse() && FrostManticorePassiveBabyProcedure.execute(entity);
               }
            }
         );
   ...
   public void die(DamageSource source) {
      super.die(source);
      FrostManticoreDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   }
   ...
   public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
      ...
      FrostManticoreBabyRightClickedProcedure.execute(world, x, y, z, entity, sourceentity);
      return retval;
   }

   public void baseTick() {
      super.baseTick();
      FrostManticoreBabyProcedure.execute(this);
   ...
   public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
      FrostManticoreEntity retval = (FrostManticoreEntity)(MocreaturesModEntities.FROST_MANTICORE.get()).create(serverWorld);
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         MocreaturesModEntities.FROST_MANTICORE.get(),
