...
import net.mocreatures.procedures.CrabOnEntityTickUpdateProcedure;
...
public class CrabEntity extends Animal implements GeoEntity {
   ...
   public void baseTick() {
      super.baseTick();
      CrabOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
      CrabEntity retval = (CrabEntity)(MocreaturesModEntities.CRAB.get()).create(serverWorld);
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         MocreaturesModEntities.CRAB.get(),
