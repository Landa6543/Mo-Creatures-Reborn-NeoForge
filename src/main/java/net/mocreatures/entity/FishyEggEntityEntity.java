...
import net.mocreatures.procedures.FishyEggHatchProcedure;
...
public class FishyEggEntityEntity extends PathfinderMob implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(FishyEggEntityEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(FishyEggEntityEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(FishyEggEntityEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<Integer> DATA_Hatch = SynchedEntityData.defineId(FishyEggEntityEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Boolean> DATA_Crack1 = SynchedEntityData.defineId(FishyEggEntityEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Boolean> DATA_Crack2 = SynchedEntityData.defineId(FishyEggEntityEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Boolean> DATA_Crack3 = SynchedEntityData.defineId(FishyEggEntityEntity.class, EntityDataSerializers.BOOLEAN);
   ...
   public FishyEggEntityEntity(EntityType<FishyEggEntityEntity> type, Level world) {
      super(type, world);
      this.xpReward = 0;
      this.setNoAi(false);
   ...
   public void baseTick() {
      super.baseTick();
      FishyEggHatchProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
