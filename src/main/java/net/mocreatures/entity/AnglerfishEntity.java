...
import net.mocreatures.procedures.AnglerfishBabyProcedure;
...
public class AnglerfishEntity extends TamableAnimal implements GeoEntity {
   ...
   public static final EntityDataAccessor<Boolean> DATA_Baby = SynchedEntityData.defineId(AnglerfishEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Integer> DATA_GrowUp = SynchedEntityData.defineId(AnglerfishEntity.class, EntityDataSerializers.INT);
      ...
      this.moveControl = new MoveControl(this) {
         public void tick() {
            if (AnglerfishEntity.this.isInWater()) {
               AnglerfishEntity.this.setDeltaMovement(AnglerfishEntity.this.getDeltaMovement().add(0.0, 0.005, 0.0));
            }

            if (this.operation == Operation.MOVE_TO && !AnglerfishEntity.this.getNavigation().isDone()) {
               ...
               AnglerfishEntity.this.setYRot(this.rotlerp(AnglerfishEntity.this.getYRot(), f, 10.0F));
               ...
               if (AnglerfishEntity.this.isInWater()) {
                  ...
                  AnglerfishEntity.this.setXRot(this.rotlerp(AnglerfishEntity.this.getXRot(), f2, 5.0F));
               ...
               AnglerfishEntity.this.setSpeed(0.0F);
               AnglerfishEntity.this.setYya(0.0F);
               AnglerfishEntity.this.setZza(0.0F);
            }
         }
      };
   }
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "smallfish_anglerfish");
   ...
   public void baseTick() {
      super.baseTick();
      AnglerfishBabyProcedure.execute(this.level(), this);
   ...
   public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
      AnglerfishEntity retval = (AnglerfishEntity)(MocreaturesModEntities.ANGLERFISH.get()).create(serverWorld);
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         MocreaturesModEntities.ANGLERFISH.get(),
