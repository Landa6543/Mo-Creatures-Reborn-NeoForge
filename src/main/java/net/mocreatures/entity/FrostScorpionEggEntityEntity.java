...
import net.mocreatures.procedures.FrostScorpionEggHatchProcedure;
...
public class FrostScorpionEggEntityEntity extends PathfinderMob implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(FrostScorpionEggEntityEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(FrostScorpionEggEntityEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(FrostScorpionEggEntityEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<Integer> DATA_Hatch = SynchedEntityData.defineId(FrostScorpionEggEntityEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Boolean> DATA_Crack1 = SynchedEntityData.defineId(FrostScorpionEggEntityEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Boolean> DATA_Crack2 = SynchedEntityData.defineId(FrostScorpionEggEntityEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Boolean> DATA_Crack3 = SynchedEntityData.defineId(FrostScorpionEggEntityEntity.class, EntityDataSerializers.BOOLEAN);
   ...
   public FrostScorpionEggEntityEntity(EntityType<FrostScorpionEggEntityEntity> type, Level world) {
      super(type, world);
      this.xpReward = 0;
      this.setNoAi(false);
   ...
   public void baseTick() {
      super.baseTick();
      FrostScorpionEggHatchProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
