...
@EventBusSubscriber
public class UnihornedOstrichTransformationProcedure {
   @SubscribeEvent
            ...
            MocreaturesMod.queueServerWork(
               ...
               () -> {
                  ...
                  if (world instanceof ServerLevel _levelx) {
                     Entity entityToSpawn = (MocreaturesModEntities.UNIHORNED_OSTRICH.get())
                  ...
                  Entity patt0$temp = world.getEntitiesOfClass(UnihornedOstrichEntity.class, AABB.ofSize(new Vec3(x, y, z), 4.0, 4.0, 4.0), e -> true)
                     .stream()
                     .sorted((new Object() {
                     ...
                     .findFirst()
                     .orElse(null);
                  if (patt0$temp instanceof UnihornedOstrichEntity _datEntSetL) {
                     _datEntSetL.getEntityData().set(UnihornedOstrichEntity.DATA_Baby, true);
                  }
               }
            );
         }
