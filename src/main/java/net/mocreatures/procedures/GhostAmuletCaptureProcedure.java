...
@EventBusSubscriber
public class GhostAmuletCaptureProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         ...
         if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)
               .is(ItemTags.create(ResourceLocation.parse("mocreatures:ghost_amulet/empty")))
            ...
            if ((
               ...
               && _tamEnt.isTame()
               && !(entity instanceof HorseEntity _datEntL6 && (Boolean)_datEntL6.getEntityData().get(HorseEntity.DATA_Baby))) {
            ...
            if (canCapture) {
               if (sourceentity instanceof LivingEntity _entity) {
                  ItemStack _setstack = new ItemStack((ItemLike)MocreaturesModItems.GHOST_AMULET_FULL.get()).copy();
               ...
               _tagName = "Leashed";
               boolean _tagValuex;
               boolean var125 = _tagValuex = entity instanceof Mob _mobEnt ? _mobEnt.isLeashed() : false;
               CustomData.update(
                  DataComponents.CUSTOM_DATA,
                  sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY,
               ...
               _tagName = "MaxHealth";
               double _tagValuexxx;
               double var126 = _tagValuexxx = entity instanceof LivingEntity _livEnt ? _livEnt.getMaxHealth() : -1.0;
               CustomData.update(
                  DataComponents.CUSTOM_DATA,
                  sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY,
               ...
               double var127 = _tagValuexxxx = entity instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1.0;
               CustomData.update(
                  DataComponents.CUSTOM_DATA,
                  sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY,
               ...
               double var128 = _tagValuexxxxxxxxxxx = entity instanceof HorseEntity _datEntI
               ...
               if (entity.getType().is(TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.parse("mocreatures:moc_horse")))) {
                  if (entity instanceof HorseEntity _datEntL53
                     && (Boolean)_datEntL53.getEntityData().get(HorseEntity.DATA_Saddle)
                  ...
                  if (entity instanceof HorseEntity _datEntL55
                     && (Boolean)_datEntL55.getEntityData().get(HorseEntity.DATA_Chest)
                     && world instanceof ServerLevel _level) {
                  ...
                  if (entity instanceof HorseEntity _datEntL57
                     && (Boolean)_datEntL57.getEntityData().get(HorseEntity.DATA_MetalArmored)
                     && world instanceof ServerLevel _level) {
                  ...
                  if (entity instanceof HorseEntity _datEntL59
                     && (Boolean)_datEntL59.getEntityData().get(HorseEntity.DATA_GoldenArmored)
                     && world instanceof ServerLevel _level) {
                  ...
                  if (entity instanceof HorseEntity _datEntL61
                     && (Boolean)_datEntL61.getEntityData().get(HorseEntity.DATA_DiamondArmored)
                     && world instanceof ServerLevel _level) {
                  ...
                  if (entity instanceof HorseEntity _datEntL63
                     && (Boolean)_datEntL63.getEntityData().get(HorseEntity.DATA_CrystalineArmored)
                     && world instanceof ServerLevel _level) {
