...
@EventBusSubscriber
public class LigerFeedProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if (entity instanceof LigerEntity
            && !(entity instanceof LigerEntity _datEntL1 && (Boolean)_datEntL1.getEntityData().get(LigerEntity.DATA_Tameable))
            && entity instanceof LigerEntity _datEntL2
            && (Boolean)_datEntL2.getEntityData().get(LigerEntity.DATA_Baby)
            && (
            ...
            if (Math.random() < 0.4) {
               if (entity instanceof LigerEntity _datEntSetL) {
                  _datEntSetL.getEntityData().set(LigerEntity.DATA_Tameable, true);
               }
