...
@EventBusSubscriber
public class DarkPegasusHorseTransformationProcedure {
   @SubscribeEvent
            ...
            MocreaturesMod.queueServerWork(
               ...
               () -> {
                  ...
                  if (entity instanceof HorseEntity _datEntSetI) {
                     _datEntSetI.getEntityData().set(HorseEntity.DATA_Variant, 106);
                  }

                  if (entity instanceof LivingEntity _livingEntity11 && _livingEntity11.getAttributes().hasAttribute(Attributes.MOVEMENT_SPEED)) {
                     _livingEntity11.getAttribute(Attributes.MOVEMENT_SPEED).setBaseValue(0.25);
                  }
               }
            );
         }
