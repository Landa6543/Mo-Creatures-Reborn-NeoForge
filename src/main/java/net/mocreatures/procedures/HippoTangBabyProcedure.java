...
public class HippoTangBabyProcedure {
   public static void execute(LevelAccessor world, Entity entity) {
      if (entity != null) {
         ...
         if (entity instanceof HippoTangEntity _datEntL4 && (Boolean)_datEntL4.getEntityData().get(HippoTangEntity.DATA_Baby)) {
            ScaleTypes.HEIGHT
               .getScaleData(entity)
         ...
         if (!(entity instanceof HippoTangEntity _datEntL7 && (Boolean)_datEntL7.getEntityData().get(HippoTangEntity.DATA_Baby))) {
