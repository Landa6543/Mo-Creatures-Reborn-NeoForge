...
public class PlainManticoreBabyProcedure {
   public static void execute(Entity var0) {
      if (var0 != null) {
         boolean var1;
         if (var0 instanceof ManticoreEntity var2 && (Boolean)var2.getEntityData().get(ManticoreEntity.DATA_Baby)) {
            var1 = true;
         } else {
            var1 = false;
         }
         ...
         if (var0 instanceof ManticoreEntity var5 && (Boolean)var5.getEntityData().get(ManticoreEntity.DATA_Baby)) {
            var1 = true;
         } else {
            var1 = false;
         }
         ...
         if (var0 instanceof ManticoreEntity var7) {
            if (Boolean.TRUE.equals(var7.getEntityData().get(ManticoreEntity.DATA_Saddled))) {
               var7.setTexture("manticore_plain_saddled");
            } else {
               var7.setTexture("manticore_plain_bare");
            }
         }
