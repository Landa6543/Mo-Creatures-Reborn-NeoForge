...
public class FishyBabyProcedure {
   public static void execute(LevelAccessor world, Entity entity) {
      if (entity != null) {
         ...
         if (entity instanceof FishyEntity _datEntL4 && (Boolean)_datEntL4.getEntityData().get(FishyEntity.DATA_Baby)) {
            ScaleTypes.HEIGHT
               .getScaleData(entity)
         ...
         if (!(entity instanceof FishyEntity _datEntL7 && (Boolean)_datEntL7.getEntityData().get(FishyEntity.DATA_Baby))) {
