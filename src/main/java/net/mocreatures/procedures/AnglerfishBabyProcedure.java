...
public class AnglerfishBabyProcedure {
   public static void execute(LevelAccessor world, Entity entity) {
      if (entity != null) {
         ...
         if (entity instanceof AnglerfishEntity _datEntL4 && (Boolean)_datEntL4.getEntityData().get(AnglerfishEntity.DATA_Baby)) {
            ScaleTypes.HEIGHT
               .getScaleData(entity)
         ...
         if (!(entity instanceof AnglerfishEntity _datEntL7 && (Boolean)_datEntL7.getEntityData().get(AnglerfishEntity.DATA_Baby))) {
