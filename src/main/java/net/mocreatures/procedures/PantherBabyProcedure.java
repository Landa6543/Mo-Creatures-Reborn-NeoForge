...
public class PantherBabyProcedure {
   public static void execute(Entity var0) {
      if (var0 != null) {
         if (var0 instanceof PantherEntity var1 && Boolean.TRUE.equals(var1.getEntityData().get(PantherEntity.DATA_Baby))) {
            ScaleTypes.HEIGHT
               .getScaleData(var0)
         ...
         } else if (var0 instanceof PantherEntity) {
            ScaleTypes.HEIGHT
               .getScaleData(var0)
         ...
         boolean var4 = var0 instanceof PantherEntity var2 && Boolean.TRUE.equals(var2.getEntityData().get(PantherEntity.DATA_Wings));
         if (var4) {
