...
public class GoldFishBabyProcedure {
   public static void execute(LevelAccessor world, Entity entity) {
      if (entity != null) {
         ...
         if (entity instanceof GoldFishEntity _datEntL4 && (Boolean)_datEntL4.getEntityData().get(GoldFishEntity.DATA_Baby)) {
            ScaleTypes.HEIGHT
               .getScaleData(entity)
         ...
         if (!(entity instanceof GoldFishEntity _datEntL7 && (Boolean)_datEntL7.getEntityData().get(GoldFishEntity.DATA_Baby))) {
