...
@EventBusSubscriber
public class TigerTransformationProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem()
            ...
            && (entity instanceof TigerEntity _datEntI ? (Integer)_datEntI.getEntityData().get(TigerEntity.DATA_Color) : 0) == 2
            && entity instanceof TigerEntity
            ...
            MocreaturesMod.queueServerWork(
               ...
               () -> {
                  ...
                  if (entity instanceof TigerEntity _datEntSetL) {
                     _datEntSetL.getEntityData().set(TigerEntity.DATA_Wings, true);
                  }
               }
            );
         }
