...
@EventBusSubscriber
public class PanthgerTransformationProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem()
            ...
            && (entity instanceof PanthgerEntity _datEntI ? (Integer)_datEntI.getEntityData().get(PanthgerEntity.DATA_Gender) : 0) == 0
            && entity instanceof PanthgerEntity
            ...
            MocreaturesMod.queueServerWork(
               ...
               () -> {
                  ...
                  if (entity instanceof PanthgerEntity _datEntSetL) {
                     _datEntSetL.getEntityData().set(PanthgerEntity.DATA_Wings, true);
                  }
               }
            );
         }
