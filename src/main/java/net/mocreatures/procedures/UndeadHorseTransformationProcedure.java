...
@EventBusSubscriber
public class UndeadHorseTransformationProcedure {
   @SubscribeEvent
            ...
            MocreaturesMod.queueServerWork(
               ...
               () -> {
                  ...
                  if (entity instanceof HorseEntity _datEntSetI) {
                     _datEntSetI.getEntityData().set(HorseEntity.DATA_Variant, 107);
                  }
                  ...
                  if (entity instanceof LivingEntity _livingEntity16 && _livingEntity16.getAttributes().hasAttribute(Attributes.MOVEMENT_SPEED)) {
                     _livingEntity16.getAttribute(Attributes.MOVEMENT_SPEED).setBaseValue(0.25);
                  }
               }
            );
         }
