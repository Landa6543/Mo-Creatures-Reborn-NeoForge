...
public class ToxicManticoreBabyProcedure {
   public static void execute(Entity var0) {
      if (var0 != null) {
         boolean var1;
         if (var0 instanceof ToxicManticoreEntity var2 && (Boolean)var2.getEntityData().get(ToxicManticoreEntity.DATA_Baby)) {
            var1 = true;
         } else {
            var1 = false;
         }
         ...
         if (var0 instanceof ToxicManticoreEntity var5 && (Boolean)var5.getEntityData().get(ToxicManticoreEntity.DATA_Baby)) {
            var1 = true;
         } else {
            var1 = false;
         }
         ...
         if (var0 instanceof ToxicManticoreEntity var7) {
            if (Boolean.TRUE.equals(var7.getEntityData().get(ToxicManticoreEntity.DATA_Saddled))) {
               var7.setTexture("manticore_toxic_saddled");
            } else {
               var7.setTexture("manticore_toxic_bare");
            }
         }
