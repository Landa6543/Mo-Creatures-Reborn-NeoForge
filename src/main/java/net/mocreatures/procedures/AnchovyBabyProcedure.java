...
public class AnchovyBabyProcedure {
   public static void execute(LevelAccessor world, Entity entity) {
      if (entity != null) {
         ...
         if (entity instanceof AnchovyEntity _datEntL4 && (Boolean)_datEntL4.getEntityData().get(AnchovyEntity.DATA_Baby)) {
            ScaleTypes.HEIGHT
               .getScaleData(entity)
         ...
         if (!(entity instanceof AnchovyEntity _datEntL7 && (Boolean)_datEntL7.getEntityData().get(AnchovyEntity.DATA_Baby))) {
