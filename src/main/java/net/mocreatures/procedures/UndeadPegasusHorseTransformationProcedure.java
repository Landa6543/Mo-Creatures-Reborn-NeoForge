...
@EventBusSubscriber
public class UndeadPegasusHorseTransformationProcedure {
   @SubscribeEvent
      ...
      if (entity != null && sourceentity != null) {
         if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem()
            ...
            if (entity instanceof LivingEntity _livingEntity8 && _livingEntity8.getAttributes().hasAttribute(Attributes.MOVEMENT_SPEED)) {
               _livingEntity8.getAttribute(Attributes.MOVEMENT_SPEED).setBaseValue(0.0);
            }
            ...
            MocreaturesMod.queueServerWork(
               ...
               () -> {
                  ...
                  if (entity instanceof HorseEntity _datEntSetL) {
                     _datEntSetL.getEntityData().set(HorseEntity.DATA_Decaying, true);
                  }

                  if (entity instanceof HorseEntity _datEntSetI) {
                     _datEntSetI.getEntityData().set(HorseEntity.DATA_Variant, 111);
                  }
                  ...
                  if (entity instanceof HorseEntity _datEntSetI) {
                     _datEntSetI.getEntityData().set(HorseEntity.DATA_NightmareTextureFrame, 0);
                  }

                  if (entity instanceof LivingEntity _livingEntity15 && _livingEntity15.getAttributes().hasAttribute(Attributes.MOVEMENT_SPEED)) {
                     _livingEntity15.getAttribute(Attributes.MOVEMENT_SPEED).setBaseValue(0.25);
                  }
               }
            );
         }
