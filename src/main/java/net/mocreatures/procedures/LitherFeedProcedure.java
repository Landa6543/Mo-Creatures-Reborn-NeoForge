...
@EventBusSubscriber
public class LitherFeedProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if (entity instanceof LitherEntity
            && !(entity instanceof LitherEntity _datEntL1 && (Boolean)_datEntL1.getEntityData().get(LitherEntity.DATA_Tameable))
            && entity instanceof LitherEntity _datEntL2
            && (Boolean)_datEntL2.getEntityData().get(LitherEntity.DATA_Baby)
            && (
            ...
            if (Math.random() < 0.4) {
               if (entity instanceof LitherEntity _datEntSetL) {
                  _datEntSetL.getEntityData().set(LitherEntity.DATA_Tameable, true);
               }
