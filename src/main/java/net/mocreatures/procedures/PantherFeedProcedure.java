...
@EventBusSubscriber
public class PantherFeedProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if (entity instanceof PantherEntity
            && !(entity instanceof PantherEntity _datEntL1 && (Boolean)_datEntL1.getEntityData().get(PantherEntity.DATA_Tameable))
            && entity instanceof PantherEntity _datEntL2
            && (Boolean)_datEntL2.getEntityData().get(PantherEntity.DATA_Baby)
            && (
            ...
            if (Math.random() < 0.4) {
               if (entity instanceof PantherEntity _datEntSetL) {
                  _datEntSetL.getEntityData().set(PantherEntity.DATA_Tameable, true);
               }
         ...
         if (entity instanceof PantherEntity
            ...
            if (entity instanceof PantherEntity _datEntSetL) {
               _datEntSetL.getEntityData().set(PantherEntity.DATA_Breed, true);
            }
         }
      }
   }
