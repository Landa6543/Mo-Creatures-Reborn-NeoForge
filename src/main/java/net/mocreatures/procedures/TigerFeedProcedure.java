...
@EventBusSubscriber
public class TigerFeedProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if (entity instanceof TigerEntity
            && !(entity instanceof TigerEntity _datEntL1 && (Boolean)_datEntL1.getEntityData().get(TigerEntity.DATA_Tameable))
            && entity instanceof TigerEntity _datEntL2
            && (Boolean)_datEntL2.getEntityData().get(TigerEntity.DATA_Baby)
            && (
            ...
            if (Math.random() < 0.4) {
               if (entity instanceof TigerEntity _datEntSetL) {
                  _datEntSetL.getEntityData().set(TigerEntity.DATA_Tameable, true);
               }
         ...
         if (entity instanceof TigerEntity
            ...
            if (entity instanceof TigerEntity _datEntSetL) {
               _datEntSetL.getEntityData().set(TigerEntity.DATA_Breed, true);
            }
         }
      }
   }
