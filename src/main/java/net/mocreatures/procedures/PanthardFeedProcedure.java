...
@EventBusSubscriber
public class PanthardFeedProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if (entity instanceof PanthardEntity
            && !(entity instanceof PanthardEntity _datEntL1 && (Boolean)_datEntL1.getEntityData().get(PanthardEntity.DATA_Tameable))
            && entity instanceof PanthardEntity _datEntL2
            && (Boolean)_datEntL2.getEntityData().get(PanthardEntity.DATA_Baby)
            && (
            ...
            if (Math.random() < 0.4) {
               if (entity instanceof PanthardEntity _datEntSetL) {
                  _datEntSetL.getEntityData().set(PanthardEntity.DATA_Tameable, true);
               }
