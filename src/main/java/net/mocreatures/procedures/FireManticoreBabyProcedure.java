...
public class FireManticoreBabyProcedure {
   public static void execute(Entity var0) {
      if (var0 != null) {
         boolean var1;
         if (var0 instanceof FireManticoreEntity var2 && (Boolean)var2.getEntityData().get(FireManticoreEntity.DATA_Baby)) {
            var1 = true;
         } else {
            var1 = false;
         }
         ...
         if (var0 instanceof FireManticoreEntity var5 && (Boolean)var5.getEntityData().get(FireManticoreEntity.DATA_Baby)) {
            var1 = true;
         } else {
            var1 = false;
         }
         ...
         if (var0 instanceof FireManticoreEntity var7) {
            if (Boolean.TRUE.equals(var7.getEntityData().get(FireManticoreEntity.DATA_Saddled))) {
               var7.setTexture("manticore_fire_saddled");
            } else {
               var7.setTexture("manticore_fire_bare");
            }
         }
