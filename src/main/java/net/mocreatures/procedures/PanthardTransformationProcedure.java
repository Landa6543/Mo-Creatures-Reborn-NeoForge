...
@EventBusSubscriber
public class PanthardTransformationProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem()
            ...
            && (entity instanceof PanthardEntity _datEntI ? (Integer)_datEntI.getEntityData().get(PanthardEntity.DATA_Gender) : 0) == 0
            && entity instanceof PanthardEntity
            ...
            MocreaturesMod.queueServerWork(
               ...
               () -> {
                  ...
                  if (entity instanceof LivingEntity _livingEntity9 && _livingEntity9.getAttributes().hasAttribute(Attributes.MOVEMENT_SPEED)) {
                     _livingEntity9.getAttribute(Attributes.MOVEMENT_SPEED).setBaseValue(0.3);
                  }

                  if (entity instanceof PanthardEntity _datEntSetL) {
                     _datEntSetL.getEntityData().set(PanthardEntity.DATA_Wings, true);
                  }
               }
            );
         }
