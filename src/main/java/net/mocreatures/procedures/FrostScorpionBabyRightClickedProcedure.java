...
public class FrostScorpionBabyRightClickedProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if (entity instanceof FrostScorpionEntity _datEntL0
            && (Boolean)_datEntL0.getEntityData().get(FrostScorpionEntity.DATA_Baby)
            ...
            if (sourceentity instanceof ServerPlayer _ent) {
               ...
               _ent.openMenu(new MenuProvider() {
                  public Component getDisplayName() {
                     return Component.literal("NamingFrostScorpion");
                  }
                  ...
                  public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
                     return new NamingFrostScorpionMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(_bpos));
                  }
               }, _bpos);
            }
         }

         if (entity instanceof FrostScorpionEntity _datEntL4 && (Boolean)_datEntL4.getEntityData().get(FrostScorpionEntity.DATA_Saddled)) {
