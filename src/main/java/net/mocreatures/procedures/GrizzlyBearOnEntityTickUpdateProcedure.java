...
public class GrizzlyBearOnEntityTickUpdateProcedure {
   public static void execute(Entity entity) {
      if (entity != null) {
         if (entity instanceof GrizzlyBearEntity _datEntL0 && (Boolean)_datEntL0.getEntityData().get(GrizzlyBearEntity.DATA_Baby)) {
            ScaleTypes.HEIGHT
               .getScaleData(entity)
         ...
         if (!(entity instanceof GrizzlyBearEntity _datEntL3 && (Boolean)_datEntL3.getEntityData().get(GrizzlyBearEntity.DATA_Baby))) {
         ...
         if (entity instanceof GrizzlyBearEntity _datEntL5 && (Boolean)_datEntL5.getEntityData().get(GrizzlyBearEntity.DATA_Sit)) {
            if (entity instanceof GrizzlyBearEntity) {
               ((GrizzlyBearEntity)entity).setAnimation("sit");
            }
         ...
         if (entity instanceof GrizzlyBearEntity _datEntL8
            && (Boolean)_datEntL8.getEntityData().get(GrizzlyBearEntity.DATA_Saddled)
            && entity instanceof GrizzlyBearEntity animatable) {
            animatable.setTexture("bear_grizzly");
         }
      }
   }
}
