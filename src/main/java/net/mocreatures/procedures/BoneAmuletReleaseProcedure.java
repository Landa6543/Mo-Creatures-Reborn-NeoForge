...
@EventBusSubscriber
public class BoneAmuletReleaseProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
      if (entity != null) {
         if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)
            .is(ItemTags.create(ResourceLocation.parse("mocreatures:bone_amulet/full")))) {
            ...
            if (!world.getEntitiesOfClass(HorseEntity.class, AABB.ofSize(new Vec3(x, y, z), 5.0, 5.0, 5.0), e -> true).isEmpty()) {
               Entity var39 = world.getEntitiesOfClass(HorseEntity.class, AABB.ofSize(new Vec3(x, y, z), 5.0, 5.0, 5.0), e -> true)
                  .stream()
                  .sorted((new Object() {
                  ...
                  .findFirst()
                  .orElse(null);
               if (var39 instanceof TamableAnimal _toTame && entity instanceof Player _owner) {
                  _toTame.tame(_owner);
               }

               var39 = world.getEntitiesOfClass(HorseEntity.class, AABB.ofSize(new Vec3(x, y, z), 5.0, 5.0, 5.0), e -> true).stream().sorted((new Object() {
                  Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                     return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
                  }
               }).compareDistOf(x, y, z)).findFirst().orElse(null);
               if (var39 instanceof LivingEntity _entity) {
                  _entity.setHealth(
               ...
               if (var39 instanceof HorseEntity _datEntSetI) {
               ...
               if (var39 instanceof HorseEntity _datEntSetI) {
                  _datEntSetI.getEntityData()
                     .set(
                        HorseEntity.DATA_DecayedStage,
                        (int)((CustomData)(entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)
                              .getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY))
                           .copyTag()
                           .getDouble("DecayStage")
                     );
               }
            }

            if (entity instanceof LivingEntity _entity) {
               ItemStack _setstack = new ItemStack((ItemLike)MocreaturesModItems.BONE_AMULET.get()).copy();
