...
@EventBusSubscriber
public class PantherAndLeopardResultProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z) {
      ...
      if (_datEntSetL instanceof PantherEntity _datEntL1 && (Boolean)_datEntL1.getEntityData().get(PantherEntity.DATA_Breed)) {
         _datEntSetL = world.getEntitiesOfClass(LeopardEntity.class, AABB.ofSize(new Vec3(x, y, z), 8.0, 8.0, 8.0), e -> true).stream().sorted((new Object() {
            Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
               return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
            }
         }).compareDistOf(x, y, z)).findFirst().orElse(null);
         if (_datEntSetL instanceof LeopardEntity _datEntL3
            && (Boolean)_datEntL3.getEntityData().get(LeopardEntity.DATA_Breed)
            ...
            var11 = world.getEntitiesOfClass(LeopardEntity.class, AABB.ofSize(new Vec3(x, y, z), 8.0, 8.0, 8.0), e -> true).stream().sorted((new Object() {
               Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                  return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
               }
            }).compareDistOf(x, y, z)).findFirst().orElse(null);
            ...
            MocreaturesMod.queueServerWork(
               ...
               () -> {
                  if (world instanceof ServerLevel _level) {
                     Entity entityToSpawn = (MocreaturesModEntities.PANTHARD.get())
                        .spawn(
                           _level,
                           BlockPos.containing(
                  ...
                  Entity patt0$temp = world.getEntitiesOfClass(
                     ...
                     .findFirst()
                     .orElse(null);
                  if (patt0$temp instanceof PanthardEntity _datEntSetLxx) {
                     _datEntSetLxx.getEntityData().set(PanthardEntity.DATA_Baby, true);
                  }
               }
            );
         }
