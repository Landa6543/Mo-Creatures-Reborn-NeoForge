...
public class DirtScorpionBabyRightClickedProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if (entity instanceof DirtScorpionEntity _datEntL0
            && (Boolean)_datEntL0.getEntityData().get(DirtScorpionEntity.DATA_Baby)
            ...
            if (sourceentity instanceof ServerPlayer _ent) {
               ...
               _ent.openMenu(new MenuProvider() {
                  public Component getDisplayName() {
                     return Component.literal("NamingDirtScorpion");
                  }
                  ...
                  public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
                     return new NamingDirtScorpionMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(_bpos));
                  }
               }, _bpos);
            }
         }

         if (entity instanceof DirtScorpionEntity _datEntL4 && (Boolean)_datEntL4.getEntityData().get(DirtScorpionEntity.DATA_Saddled)) {
