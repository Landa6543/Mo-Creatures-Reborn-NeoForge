...
public class SharkBabyProcedure {
   public static void execute(LevelAccessor world, Entity entity) {
      if (entity != null) {
         ...
         if (entity instanceof SharkEntity _datEntL4 && (Boolean)_datEntL4.getEntityData().get(SharkEntity.DATA_Baby)) {
            ScaleTypes.HEIGHT
               .getScaleData(entity)
         ...
         if (!(entity instanceof SharkEntity _datEntL7 && (Boolean)_datEntL7.getEntityData().get(SharkEntity.DATA_Baby))) {
