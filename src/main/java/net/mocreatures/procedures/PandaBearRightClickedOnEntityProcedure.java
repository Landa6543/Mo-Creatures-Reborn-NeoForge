...
public class PandaBearRightClickedOnEntityProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if (entity instanceof PandaBearEntity _datEntL0
            && (Boolean)_datEntL0.getEntityData().get(PandaBearEntity.DATA_Baby)
            ...
            if (sourceentity instanceof ServerPlayer _ent) {
               ...
               _ent.openMenu(new MenuProvider() {
                  public Component getDisplayName() {
                     return Component.literal("NamingPandaBear");
                  }
                  ...
                  public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
                     return new NamingPandaBearMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(_bpos));
                  }
               }, _bpos);
            }
         }
         ...
         if (!(entity instanceof PandaBearEntity _datEntL5 && (Boolean)_datEntL5.getEntityData().get(PandaBearEntity.DATA_Sit))
            ...
            _datEntSetL.getEntityData().set(PandaBearEntity.DATA_Sit, true);
         }

         if (entity instanceof PandaBearEntity _datEntL10
            && (Boolean)_datEntL10.getEntityData().get(PandaBearEntity.DATA_Sit)
            && sourceentity.isShiftKeyDown()
            && entity instanceof TamableAnimal _tamEnt
            && _tamEnt.isTame()
            && (sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == MocreaturesModItems.WHIP.get()) {
            if (entity instanceof PandaBearEntity _datEntSetL) {
               _datEntSetL.getEntityData().set(PandaBearEntity.DATA_Sit, false);
            }

            if (entity instanceof PandaBearEntity) {
               ((PandaBearEntity)entity).setAnimation("empty");
            }
         ...
         if (!(entity instanceof PandaBearEntity _datEntL18 && (Boolean)_datEntL18.getEntityData().get(PandaBearEntity.DATA_Saddled))
            ...
            && _tamEnt.isTame()) {
            if (entity instanceof PandaBearEntity _datEntSetL) {
               _datEntSetL.getEntityData().set(PandaBearEntity.DATA_Saddled, true);
            }
         ...
         if (entity instanceof PandaBearEntity _datEntL24
            && (Boolean)_datEntL24.getEntityData().get(PandaBearEntity.DATA_Saddled)
            && !(entity instanceof PandaBearEntity _datEntL25 && (Boolean)_datEntL25.getEntityData().get(PandaBearEntity.DATA_Baby))
            && entity instanceof TamableAnimal _tamEnt
            && _tamEnt.isTame()) {
