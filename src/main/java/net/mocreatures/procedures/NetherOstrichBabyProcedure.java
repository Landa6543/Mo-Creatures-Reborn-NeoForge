...
public class NetherOstrichBabyProcedure {
   public static void execute(Entity var0) {
      if (var0 != null) {
         if (var0 instanceof NetherOstrichEntity var1 && Boolean.TRUE.equals(var1.getEntityData().get(NetherOstrichEntity.DATA_Baby))) {
            ScaleTypes.HEIGHT
               .getScaleData(var0)
         ...
         } else if (var0 instanceof NetherOstrichEntity) {
