...
@EventBusSubscriber
public class LitherTransformationProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem()
            ...
            && (entity instanceof LitherEntity _datEntI ? (Integer)_datEntI.getEntityData().get(LitherEntity.DATA_Gender) : 0) == 0
            && entity instanceof LitherEntity
            ...
            MocreaturesMod.queueServerWork(
               ...
               () -> {
                  ...
                  if (entity instanceof LitherEntity _datEntSetL) {
                     _datEntSetL.getEntityData().set(LitherEntity.DATA_Wings, true);
                  }
               }
            );
         }
