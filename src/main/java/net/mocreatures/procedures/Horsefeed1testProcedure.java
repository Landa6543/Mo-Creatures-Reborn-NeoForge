...
@EventBusSubscriber
public class Horsefeed1testProcedure {
   @SubscribeEvent
      ...
      if (entity != null && sourceentity != null) {
         if (entity instanceof Horse
            ...
            if (sourceentity instanceof Player _player) {
               ...
               ItemStack var18 = _stktoremove = sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY;
            ...
            entity.getPersistentData().putBoolean("MocBreed", true);
         }
      }
   }
}
