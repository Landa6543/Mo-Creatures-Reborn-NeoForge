...
@EventBusSubscriber
public class HorseDiamondSaddleDisplayConditionProcedure {
   @SubscribeEvent
   ...
   private static boolean execute(@Nullable Event event, Entity entity) {
      return entity == null
         ...
         : (
            ...
            && !(entity instanceof HorseEntity _datEntL4 && (Boolean)_datEntL4.getEntityData().get(HorseEntity.DATA_GoldenArmored))
            && entity instanceof HorseEntity _datEntL5
            && (Boolean)_datEntL5.getEntityData().get(HorseEntity.DATA_DiamondArmored)
            ...
            && (Boolean)_datEntL7.getEntityData().get(HorseEntity.DATA_Saddle);
   }
}
