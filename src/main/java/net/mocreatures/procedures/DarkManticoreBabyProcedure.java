...
public class DarkManticoreBabyProcedure {
   public static void execute(Entity var0) {
      if (var0 != null) {
         boolean var1;
         if (var0 instanceof DarkManticoreEntity var2 && (Boolean)var2.getEntityData().get(DarkManticoreEntity.DATA_Baby)) {
            var1 = true;
         } else {
            var1 = false;
         }
         ...
         if (var0 instanceof DarkManticoreEntity var5 && (Boolean)var5.getEntityData().get(DarkManticoreEntity.DATA_Baby)) {
            var1 = true;
         } else {
            var1 = false;
         }
         ...
         if (var0 instanceof DarkManticoreEntity var7) {
            if (Boolean.TRUE.equals(var7.getEntityData().get(DarkManticoreEntity.DATA_Saddled))) {
               var7.setTexture("manticore_dark_saddled");
            } else {
               var7.setTexture("manticore_dark_bare");
            }
         }
