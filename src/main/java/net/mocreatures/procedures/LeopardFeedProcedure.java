...
@EventBusSubscriber
public class LeopardFeedProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if (entity instanceof LeopardEntity
            && !(entity instanceof LeopardEntity _datEntL1 && (Boolean)_datEntL1.getEntityData().get(LeopardEntity.DATA_Tameable))
            && entity instanceof LeopardEntity _datEntL2
            && (Boolean)_datEntL2.getEntityData().get(LeopardEntity.DATA_Baby)
            && (
            ...
            if (Math.random() < 0.4) {
               if (entity instanceof LeopardEntity _datEntSetL) {
                  _datEntSetL.getEntityData().set(LeopardEntity.DATA_Tameable, true);
               }
         ...
         if (entity instanceof LeopardEntity
            ...
            if (sourceentity instanceof Player _player) {
               ItemStack _stktoremove;
               ItemStack var34 = _stktoremove = sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY;
               _player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
            }
            ...
            if (entity instanceof LeopardEntity _datEntSetL) {
               _datEntSetL.getEntityData().set(LeopardEntity.DATA_Breed, true);
            }
         }
      }
   }
