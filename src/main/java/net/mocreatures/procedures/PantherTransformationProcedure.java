...
@EventBusSubscriber
public class PantherTransformationProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem()
            ...
            && (entity instanceof PantherEntity _datEntI ? (Integer)_datEntI.getEntityData().get(PantherEntity.DATA_Gender) : 0) == 0
            && entity instanceof PantherEntity
            ...
            MocreaturesMod.queueServerWork(
               ...
               () -> {
                  ...
                  if (entity instanceof PantherEntity _datEntSetL) {
                     _datEntSetL.getEntityData().set(PantherEntity.DATA_Wings, true);
                  }
               }
            );
         }
