...
public class AngelfishBabyProcedure {
   public static void execute(LevelAccessor world, Entity entity) {
      if (entity != null) {
         ...
         if (entity instanceof AngelfishEntity _datEntL4 && (Boolean)_datEntL4.getEntityData().get(AngelfishEntity.DATA_Baby)) {
            ScaleTypes.HEIGHT
               .getScaleData(entity)
         ...
         if (!(entity instanceof AngelfishEntity _datEntL7 && (Boolean)_datEntL7.getEntityData().get(AngelfishEntity.DATA_Baby))) {
