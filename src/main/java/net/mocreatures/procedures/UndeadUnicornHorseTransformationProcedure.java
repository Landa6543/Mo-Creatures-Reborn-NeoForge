...
@EventBusSubscriber
public class UndeadUnicornHorseTransformationProcedure {
   @SubscribeEvent
            ...
            MocreaturesMod.queueServerWork(
               ...
               () -> {
                  ...
                  if (entity instanceof HorseEntity _datEntSetI) {
                     _datEntSetI.getEntityData().set(HorseEntity.DATA_Variant, 113);
                  }
                  ...
                  if (entity instanceof LivingEntity _livingEntity13 && _livingEntity13.getAttributes().hasAttribute(Attributes.MOVEMENT_SPEED)) {
                     _livingEntity13.getAttribute(Attributes.MOVEMENT_SPEED).setBaseValue(0.25);
                  }
               }
            );
         }
