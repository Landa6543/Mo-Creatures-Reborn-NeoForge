...
@EventBusSubscriber
public class TigerAndLionResultProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z) {
      Entity _datEntSetL = world.getEntitiesOfClass(TigerEntity.class, AABB.ofSize(new Vec3(x, y, z), 8.0, 8.0, 8.0), e -> true)
         .stream()
         .sorted((new Object() {
         ...
         .findFirst()
         .orElse(null);
      if (_datEntSetL instanceof TigerEntity _datEntL1 && (Boolean)_datEntL1.getEntityData().get(TigerEntity.DATA_Breed)) {
         ...
         if (_datEntSetL instanceof LionEntity _datEntL3 && (Boolean)_datEntL3.getEntityData().get(LionEntity.DATA_Breed)) {
            ...
            if ((_datEntSetL instanceof LionEntity _datEntI ? (Integer)_datEntI.getEntityData().get(LionEntity.DATA_LionGender) : 0) == 2
               ...
               Entity var12 = world.getEntitiesOfClass(LionEntity.class, AABB.ofSize(new Vec3(x, y, z), 8.0, 8.0, 8.0), e -> true)
                  .stream()
                  .sorted((new Object() {
                     Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                        return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
               ...
               var12 = world.getEntitiesOfClass(TigerEntity.class, AABB.ofSize(new Vec3(x, y, z), 8.0, 8.0, 8.0), e -> true).stream().sorted((new Object() {
                  Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                     return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
                  }
               }).compareDistOf(x, y, z)).findFirst().orElse(null);
               if (var12 instanceof TigerEntity _datEntSetLx) {
               ...
               MocreaturesMod.queueServerWork(
                  ...
                  () -> {
                     if (world instanceof ServerLevel _level) {
                        Entity entityToSpawn = (MocreaturesModEntities.LIGER.get())
                           .spawn(
                              _level,
                              BlockPos.containing(
                                 world.getEntitiesOfClass(TigerEntity.class, AABB.ofSize(new Vec3(x, y, z), 8.0, 8.0, 8.0), e -> true)
                                    .stream()
                                    .sorted((new Object() {
                                       Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                                          return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
                     ...
                     Entity patt0$temp = world.getEntitiesOfClass(
                        ...
                        .findFirst()
                        .orElse(null);
                     if (patt0$temp instanceof LigerEntity _datEntSetLxx) {
                        _datEntSetLxx.getEntityData().set(LigerEntity.DATA_Baby, true);
                     }
                  }
               );
            }
