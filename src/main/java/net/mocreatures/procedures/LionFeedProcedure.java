...
@EventBusSubscriber
public class LionFeedProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if (entity instanceof LionEntity
            && !(entity instanceof LionEntity _datEntL1 && (Boolean)_datEntL1.getEntityData().get(LionEntity.DATA_Tameable))
            && entity instanceof LionEntity _datEntL2
            && (Boolean)_datEntL2.getEntityData().get(LionEntity.DATA_Baby)
            && (
            ...
            if (Math.random() < 0.4) {
               if (entity instanceof LionEntity _datEntSetL) {
                  _datEntSetL.getEntityData().set(LionEntity.DATA_Tameable, true);
               }
         ...
         if (entity instanceof LionEntity
            ...
            if (entity instanceof LionEntity _datEntSetL) {
               _datEntSetL.getEntityData().set(LionEntity.DATA_Breed, true);
            }
         }
      }
   }
