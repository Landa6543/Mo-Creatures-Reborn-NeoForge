...
@EventBusSubscriber
public class PanthardEquipmentProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event var0, Entity var1, Entity var2) {
      if (var1 != null && var2 != null) {
         if (var1 instanceof PanthardEntity var3 && var1 instanceof TamableAnimal var4 && var4.isTame()) {
            if (var2 instanceof Player var5) {
               boolean var6 = Boolean.TRUE.equals(var3.getEntityData().get(PanthardEntity.DATA_Saddle));
               boolean var7 = Boolean.TRUE.equals(var3.getEntityData().get(PanthardEntity.DATA_Chest));
               ...
               if (var6
                  ...
                  if (!var7 && var8.is(Blocks.CHEST.asItem())) {
                     ...
                     var3.getEntityData().set(PanthardEntity.DATA_Chest, true);
                  }
               } else {
                  if (!var5.getAbilities().instabuild) {
                     var8.shrink(1);
                  ...
                  var3.getEntityData().set(PanthardEntity.DATA_Saddle, true);
               }
            }
         }
      }
