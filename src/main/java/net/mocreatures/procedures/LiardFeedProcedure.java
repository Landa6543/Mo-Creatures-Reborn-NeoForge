...
@EventBusSubscriber
public class LiardFeedProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if (entity instanceof LiardEntity
            && !(entity instanceof LiardEntity _datEntL1 && (Boolean)_datEntL1.getEntityData().get(LiardEntity.DATA_Tameable))
            && entity instanceof LiardEntity _datEntL2
            && (Boolean)_datEntL2.getEntityData().get(LiardEntity.DATA_Baby)
            && (
            ...
            if (Math.random() < 0.4) {
               if (entity instanceof LiardEntity _datEntSetL) {
                  _datEntSetL.getEntityData().set(LiardEntity.DATA_Tameable, true);
               }
