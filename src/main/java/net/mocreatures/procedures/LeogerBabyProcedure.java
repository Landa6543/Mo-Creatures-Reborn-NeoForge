...
public class LeogerBabyProcedure {
   public static void execute(Entity entity) {
      if (entity != null) {
         if (entity instanceof LeogerEntity _datEntL0 && (Boolean)_datEntL0.getEntityData().get(LeogerEntity.DATA_Baby)) {
            ScaleTypes.HEIGHT
               .getScaleData(entity)
         ...
         if (!(entity instanceof LeogerEntity _datEntL3 && (Boolean)_datEntL3.getEntityData().get(LeogerEntity.DATA_Baby))) {
            ScaleTypes.HEIGHT
               .getScaleData(entity)
