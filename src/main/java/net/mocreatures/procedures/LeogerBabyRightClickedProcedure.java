...
public class LeogerBabyRightClickedProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if (entity instanceof LeogerEntity _datEntL0
            && (Boolean)_datEntL0.getEntityData().get(LeogerEntity.DATA_Baby)
            && entity instanceof LeogerEntity _datEntL1
            && (Boolean)_datEntL1.getEntityData().get(LeogerEntity.DATA_Tameable)
            ...
            if (sourceentity instanceof ServerPlayer _ent) {
               ...
               _ent.openMenu(new MenuProvider() {
                  public Component getDisplayName() {
                     return Component.literal("NamingLeoger");
                  }
                  ...
                  public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
                     return new NamingLeogerMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(_bpos));
                  }
               }, _bpos);
            }
            ...
            if (entity instanceof LeogerEntity _datEntSetL) {
               _datEntSetL.getEntityData().set(LeogerEntity.DATA_Medallion, true);
            }
         }
      }
   }
