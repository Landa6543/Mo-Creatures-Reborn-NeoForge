...
public class PiranhaBabyProcedure {
   public static void execute(LevelAccessor world, Entity entity) {
      if (entity != null) {
         ...
         if (entity instanceof PiranhaEntity _datEntL4 && (Boolean)_datEntL4.getEntityData().get(PiranhaEntity.DATA_Baby)) {
            ScaleTypes.HEIGHT
               .getScaleData(entity)
         ...
         if (!(entity instanceof PiranhaEntity _datEntL7 && (Boolean)_datEntL7.getEntityData().get(PiranhaEntity.DATA_Baby))) {
