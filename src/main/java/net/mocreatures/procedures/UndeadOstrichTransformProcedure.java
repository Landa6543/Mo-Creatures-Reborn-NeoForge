...
@EventBusSubscriber
public class UndeadOstrichTransformProcedure {
   @SubscribeEvent
            ...
            MocreaturesMod.queueServerWork(
               ...
               () -> {
                  ...
                  if (world instanceof ServerLevel _levelx) {
                     Entity entityToSpawn = (MocreaturesModEntities.UNDEAD_OSTRICH.get())
                  ...
                  Entity patt0$temp = world.getEntitiesOfClass(UndeadOstrichEntity.class, AABB.ofSize(new Vec3(x, y, z), 4.0, 4.0, 4.0), e -> true)
                     .stream()
                     .sorted((new Object() {
                     ...
                     .findFirst()
                     .orElse(null);
                  if (patt0$temp instanceof UndeadOstrichEntity _datEntSetL) {
                     _datEntSetL.getEntityData().set(UndeadOstrichEntity.DATA_Baby, true);
                  }
               }
            );
         }
