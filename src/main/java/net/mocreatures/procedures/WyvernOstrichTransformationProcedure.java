...
@EventBusSubscriber
public class WyvernOstrichTransformationProcedure {
   @SubscribeEvent
            ...
            MocreaturesMod.queueServerWork(
               ...
               () -> {
                  ...
                  if (world instanceof ServerLevel _levelx) {
                     Entity entityToSpawn = (MocreaturesModEntities.WYVERN_OSTRICH.get())
                  ...
                  Entity patt0$temp = world.getEntitiesOfClass(WyvernOstrichEntity.class, AABB.ofSize(new Vec3(x, y, z), 4.0, 4.0, 4.0), e -> true)
                     .stream()
                     .sorted((new Object() {
                     ...
                     .findFirst()
                     .orElse(null);
                  if (patt0$temp instanceof WyvernOstrichEntity _datEntSetL) {
                     _datEntSetL.getEntityData().set(WyvernOstrichEntity.DATA_Baby, true);
                  }
               }
            );
         }
