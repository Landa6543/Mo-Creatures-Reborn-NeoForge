...
@EventBusSubscriber
public class FrostManticoreSaddleOnRightClickProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == MocreaturesModItems.CRAFTED_SADDLE.get()
            && entity instanceof FrostManticoreEntity
            ...
            if (entity instanceof FrostManticoreEntity _datEntSetL) {
               _datEntSetL.getEntityData().set(FrostManticoreEntity.DATA_Saddled, true);
            }
         }
      }
   }
