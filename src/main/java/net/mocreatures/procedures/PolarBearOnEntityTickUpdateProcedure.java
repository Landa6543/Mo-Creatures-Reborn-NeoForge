...
public class PolarBearOnEntityTickUpdateProcedure {
   public static void execute(Entity entity) {
      if (entity != null) {
         if (entity instanceof PolarBearEntity _datEntL0 && (Boolean)_datEntL0.getEntityData().get(PolarBearEntity.DATA_Baby)) {
            ScaleTypes.HEIGHT
               .getScaleData(entity)
         ...
         if (!(entity instanceof PolarBearEntity _datEntL3 && (Boolean)_datEntL3.getEntityData().get(PolarBearEntity.DATA_Baby))) {
         ...
         if (entity instanceof PolarBearEntity _datEntL5 && (Boolean)_datEntL5.getEntityData().get(PolarBearEntity.DATA_Sit)) {
            if (entity instanceof PolarBearEntity) {
               ((PolarBearEntity)entity).setAnimation("sit");
            }
         ...
         if (entity instanceof PolarBearEntity _datEntL8
            && (Boolean)_datEntL8.getEntityData().get(PolarBearEntity.DATA_Saddled)
            && entity instanceof PolarBearEntity animatable) {
            animatable.setTexture("bear_polar");
         }
      }
   }
}
