...
@EventBusSubscriber
public class DeerDoeRightClickedOnEntityProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.WHEAT_SEEDS) {
            if (entity instanceof DeerDoeEntity _datEntSetL) {
               _datEntSetL.getEntityData().set(DeerDoeEntity.DATA_Breed, true);
            }
