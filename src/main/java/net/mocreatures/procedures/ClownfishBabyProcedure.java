...
public class ClownfishBabyProcedure {
   public static void execute(LevelAccessor world, Entity entity) {
      if (entity != null) {
         ...
         if (entity instanceof ClownfishEntity _datEntL4 && (Boolean)_datEntL4.getEntityData().get(ClownfishEntity.DATA_Baby)) {
            ScaleTypes.HEIGHT
               .getScaleData(entity)
         ...
         if (!(entity instanceof ClownfishEntity _datEntL7 && (Boolean)_datEntL7.getEntityData().get(ClownfishEntity.DATA_Baby))) {
