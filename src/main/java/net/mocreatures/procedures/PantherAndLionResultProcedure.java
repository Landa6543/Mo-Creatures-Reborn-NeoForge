...
@EventBusSubscriber
public class PantherAndLionResultProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z) {
      ...
      if (_datEntSetL instanceof PantherEntity _datEntL1 && (Boolean)_datEntL1.getEntityData().get(PantherEntity.DATA_Breed)) {
         ...
         if (_datEntSetL instanceof LionEntity _datEntL3
            && (Boolean)_datEntL3.getEntityData().get(LionEntity.DATA_Breed)
            ...
            var11 = world.getEntitiesOfClass(LionEntity.class, AABB.ofSize(new Vec3(x, y, z), 8.0, 8.0, 8.0), e -> true).stream().sorted((new Object() {
               Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                  return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
               }
            }).compareDistOf(x, y, z)).findFirst().orElse(null);
            if (var11 instanceof LionEntity _datEntSetLx) {
            ...
            MocreaturesMod.queueServerWork(
               ...
               () -> {
                  if (world instanceof ServerLevel _level) {
                     Entity entityToSpawn = (MocreaturesModEntities.LITHER.get())
                        .spawn(
                           _level,
                           BlockPos.containing(
                  ...
                  Entity patt0$temp = world.getEntitiesOfClass(
                     ...
                     .findFirst()
                     .orElse(null);
                  if (patt0$temp instanceof LitherEntity _datEntSetLxx) {
                     _datEntSetLxx.getEntityData().set(LitherEntity.DATA_Baby, true);
                  }
               }
            );
         }
