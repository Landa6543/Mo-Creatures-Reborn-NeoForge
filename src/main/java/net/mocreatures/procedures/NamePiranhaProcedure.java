...
public class NamePiranhaProcedure {
   public static void execute(LevelAccessor var0, double var1, double var3, double var5, Entity var7, HashMap var8) {
      if (var7 != null && var8 != null) {
         if (var7 instanceof Player var9 && var9.containerMenu instanceof NamingPiranhaMenu && var8.containsKey("text:Name")) {
            ...
            if (var11 != null && !var11.trim().isEmpty()) {
               ...
               Entity var16 = var0.getEntitiesOfClass(PiranhaEntity.class, AABB.ofSize(new Vec3(var1, var3, var5), 8.0, 8.0, 8.0), var0x -> true)
                  .stream()
