...
public class PantherDiesProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
      if (entity != null) {
         if (entity instanceof PantherEntity _datEntL0
            && (Boolean)_datEntL0.getEntityData().get(PantherEntity.DATA_Saddle)
         ...
         if (entity instanceof PantherEntity _datEntL2
            && (Boolean)_datEntL2.getEntityData().get(PantherEntity.DATA_Chest)
            && world instanceof ServerLevel _level) {
         ...
         if (entity instanceof PantherEntity _datEntL4
            && (Boolean)_datEntL4.getEntityData().get(PantherEntity.DATA_Medallion)
            && world instanceof ServerLevel _level) {
