...
@EventBusSubscriber
public class LigerTransformationProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem()
            ...
            && (entity instanceof LigerEntity _datEntI ? (Integer)_datEntI.getEntityData().get(LigerEntity.DATA_Gender) : 0) == 0
            && entity instanceof LigerEntity
            ...
            MocreaturesMod.queueServerWork(
               ...
               () -> {
                  ...
                  if (entity instanceof LigerEntity _datEntSetL) {
                     _datEntSetL.getEntityData().set(LigerEntity.DATA_Wings, true);
                  }
               }
            );
         }
