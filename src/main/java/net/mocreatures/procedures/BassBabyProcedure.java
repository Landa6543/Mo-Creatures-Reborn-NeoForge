...
public class BassBabyProcedure {
   public static void execute(LevelAccessor world, Entity entity) {
      if (entity != null) {
         ...
         if (entity instanceof BassEntity _datEntL4 && (Boolean)_datEntL4.getEntityData().get(BassEntity.DATA_Baby)) {
            ScaleTypes.HEIGHT
               .getScaleData(entity)
         ...
         if (!(entity instanceof BassEntity _datEntL7 && (Boolean)_datEntL7.getEntityData().get(BassEntity.DATA_Baby))) {
